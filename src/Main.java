public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < createHeroes().length; i++) {
            System.out.println("Hero"+ (i+1) + " health: " + createHeroes()[i].getHealth() + " Hero: " + (i+1) + " heroes damage;" + createHeroes()[i].getDamage()
                    + "Hero"+(i+1) + " UltimateSkill: "  + createHeroes()[i].getUltimateSkill());
        }
        ...
        System.out.println(  "Hero:" +    " damage: "  + heroes.getDamage() + " ; Health: " + heroes.getHealth() +
                " ; Ultimate Skill: " + heroes.getUltimateSkill() );
